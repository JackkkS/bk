...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                        ...
                        <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">For Admin</a>
                ...
                <div class="container">
                    ...
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a href="{{ route('index') }}" class="nav-link active" aria-current="page">หน้าแรก</a></li>
                ...
                <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <img src="{{ asset('img/bk/main1.jpg') }}" style = "width:100%; height:550px;" />
                        <div class="container">
                    ...
                    <img src="{{ asset('img/bk/main2.jpg') }}" style = "width:100%; height:550px;" />
                        <div class="container">
                    ...
                    <div class="carousel-item">
                    <img src="{{ asset('img/bk/main3.jpg') }}" style = "width:100%; height:550px;" />
                        <div class="container">
                    ...
                    <div class="carousel-item">
                    <img src="{{ asset('img/bk/main4.jpg') }}" style = "width:100%; height:550px;" />
                        <div class="container">
                        <div class="carousel-caption text-end"></div>
                        </div>
                    </div>
